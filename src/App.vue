...
async function getData() {
  try {
    ...
    data.value = await response.json(); // 解析 JSON 数据 
    ...
    <div>
      ...
      <mdui-button v-if="data.hander.qqid"
        ...
        <svg style="margin-right: 4px; margin-left: -8px;" t="1710511663193" class="icon" viewBox="0 0 1024 1024"
          version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="10893" id="mx_n_1710511663194" width="20" height="20">
          <path
      ...
      <mdui-button v-for="item in data.hander.links" :icon="item.icon" style="margin-top: .5rem;" 
        :href="item.url">{{ item.title
        }}</mdui-button>
    </div>
  </mdui-card>
  <mdui-card variant="outlined" style="width: 100%;  margin-top: 26rem; padding:1rem;">
